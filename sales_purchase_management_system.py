...
#bd means border
        HeadFrame =Frame(MainFrame,bd=2,padx=50,pady=10,bg='Maroon',relief=RIDGE)
...
# here we add just title of project with decoration part menas fg four ground text color    
        self.ITitle = Label(HeadFrame,font=('arial',50,'bold'),fg='white',text = 'Sales purchase management system  ',bg='Maroon')  
        self.ITitle.grid()
#OperationFrame to perform the operation put it into mainframe
        OperationFrame = Frame(MainFrame,bd=1,width=1320,height=60,padx=50,pady=20,bg='Maroon',relief=RIDGE)
...
#The body frame contains the two body right body for slider and left for entry and labels
        LeftBodyFrame =LabelFrame(BodyFrame,bd=2,width=600,height=500,padx=20,pady=10,bg='sky blue',relief=RIDGE,font=('Cambria',15,'bold'),
                        text='Product Item details:')
        LeftBodyFrame.pack(side=LEFT)
        RightBodyFrame =LabelFrame(BodyFrame,bd=2,width=400,height=380,padx=20,pady=10,bg='sky blue',relief=RIDGE,font=('Cambria',15,'bold'),
                        text='Product Item details:')
        RightBodyFrame.pack(side=RIGHT)
#Add the labels and entry to the left body W-west aglin
        self.labelpID=Label(LeftBodyFrame,font=('Cambria',14,'bold'),text = "Product Id:-",padx=2,pady=2,bg='sky blue')
        ...
        self.labelpName=Label(LeftBodyFrame,font=('Cambria',14,'bold'),text = "Product Name:-",padx=2,pady=2,bg='sky blue')
        ...
        self.labelpPrice=Label(LeftBodyFrame,font=('Cambria',14,'bold'),text = "Product Price:-",padx=2,pady=2,bg='sky blue')
        ...
        self.labelpQty=Label(LeftBodyFrame,font=('Cambria',14,'bold'),text = "Product Qty:-",padx=2,pady=2,bg='sky blue')
        ...
        self.labelpCompany=Label(LeftBodyFrame,font=('Cambria',14,'bold'),text = "Product Company:-",padx=2,pady=2,bg='sky blue')
        ...
        self.labelpContact=Label(LeftBodyFrame,font=('Cambria',14,'bold'),text = "Product Contact:-",padx=2,pady=2,bg='sky blue')
...
# Now we add the buttons on the operational frame
        self.buttonSaveData = Button(OperationFrame,text='Save',font=('arial',18,'bold'),height=1,width='10',bg='orange',bd=4,command=insert)
        self.buttonSaveData.grid(row=0,column=0)
# The button for showdata        
        self.buttonShowData = Button(OperationFrame,text='Show Data',font=('arial',18,'bold'),height=1,width='10',bg='orange',bd=4,command=showInProductList)
        self.buttonShowData .grid(row=0,column=1)
# The button for cleardata        
        self.buttonClearData = Button(OperationFrame,text='Reset',font=('arial',18,'bold'),height=1,width='10',bg='orange',bd=4,command=clear)
        self.buttonClearData.grid(row=0,column=2)
# The button for deletedata        
        self.buttonDeleteData= Button(OperationFrame,text='Delete',font=('arial',18,'bold'),height=1,width='10',bg='orange',bd=4,command=delete)
        self.buttonDeleteData.grid(row=0,column=3)
# The button for searchdata        
        self.buttonSearchData = Button(OperationFrame,text='Search',font=('arial',18,'bold'),height=1,width='10',bg='orange',bd=4,command=serach)
        self.buttonSearchData .grid(row=0,column=4)
# The button for updatedata        
        self.buttonUpdateData = Button(OperationFrame,text='Update',font=('arial',18,'bold'),height=1,width='10',bg='orange',bd=4,command=update)
        self.buttonUpdateData.grid(row=0,column=5)
# The button for closedata        
        self.buttonCloseData = Button(OperationFrame,text='Close',font=('arial',18,'bold'),height=1,width='10',bg='orange',bd=4,command=close)
